...
//    in the future;
    ...
    @Override
    public void createFace(FaceUri faceUri, FaceCreatedCallback faceCreatedCallback,
        ...
        faceConnectFailedCallback.onFail("No channels available to connect to "
                + faceUri.getInet().getHostAddress() + ":" + faceUri.getPort());
    }
